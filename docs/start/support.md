...
| `pnpm verify:routing-quality`              | Configured provider/model; key when required. | Opt-in routing evaluation for Agent responsibilities, original-message delivery, and per-assignment Project scopes. Parser tests do not provide this evidence.               |
